window.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll(".form__input").forEach((input) => {
        input.addEventListener("input", function () {
            ...
            if (Object.values(formValid).every(item => item)) {
                document.querySelector('.form__button .btn').classList.remove('disabled');
            } else {
                document
    ...
    document
        ...
        .addEventListener("submit", function (event) {
            ...
            document.querySelector(".form__button .btn").innerHTML = "<div></div>";
            ...
            // Reset Form
            document.querySelector(".form__button .btn").innerHTML = "Send Message";
            form.reset();
        });
